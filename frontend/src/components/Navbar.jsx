...
const Navbar = () => {
    ...
    return (
        <nav className="bg-stone-50 border-b border-stone-300 p-4 relative">
            <div className="absolute bottom-0 left-0 right-0 h-px bg-stone-400 opacity-60"></div>

            <div className="max-w-6xl mx-auto flex justify-between items-center">
                <div className="relative">
                    <button className="text-stone-700 font-light text-2xl hover:text-stone-500 transition-colors duration-200 border-b border-transparent hover:border-stone-500"
